      ...
      <div className="container">
        ...
        <div className="notifyRight">
          ...
          <ul>
            ...
            <li>
              ISTM Journal of Training, Research and Governance, Vol 3 Issue 2
              and Vol 4 Issue 1 - June 2023
            </li>
          </ul>
          <div className="buttons">
            <button onClick={prevSlide} className="iconButton">
              <FaArrowLeft />
            </button>
      ...
      <div className="centerBlock">
        <div className="centertems">
          <div className="center-menu">
            <NavLink to="/home">Online Nomination Form</NavLink>
